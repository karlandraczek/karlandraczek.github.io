...
lang: "en-gb"
image: "assets/images/Karl_selfie.jpeg"
toc: false
about:
  id: personal-section
  template: trestles
  ...
  - icon: envelope
    text: Email
    href: mailto:karlandraczek@idiv.de
  - icon: github
    text: Github
    href: https://github.com/karlandraczek
  - icon: box-seam
    text: Zenodo
    href: https://zenodo.org/search?q=metadata.creators.person_or_org.name%3A%22Andraczek%2C%20Karl%22&l=list&p=1&s=10&sort=bestmatch
  - icon: boxes
    text: "ORCID 0000-0002-2711-3326"
    href: https://orcid.org/0000-0002-2711-3326
  - icon: bank
    text: ResearchGate
    href: https://www.researchgate.net/profile/Karl-Andraczek
  - icon: building
    text: iDiv
    href: https://www.idiv.de/en/profile/1964.html
---
...
```
::: {#personal-section}
My name is Karl Andraczek and I am an ecologist working on understanding biodiversity’s role in ecosystem functioning, particularly how their feedbacks respond to global changes.
